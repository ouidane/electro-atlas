...
const ShopWithSidebar = ({ productsData, filtersData }: { productsData: ProductListResponse, filtersData: FilterResponse }) => {
  ...
  const getPageNumbers = () => {
    const { page, totalPages } = productsData.metadata;
    const pages = [];
    if (totalPages <= 7) {
          ...
          <div className="flex gap-7.5">
            ...
            <div className="xl:max-w-[870px] w-full">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <p>
                      ...
                      <span className="text-dark">
                        {`${productsData.metadata.limit}`} of{" "}
                        {`${productsData.metadata.totalDocs}`}
                      </span>{" "}
                      Products
                    </p>
                  </div>
              ...
              <div className="flex justify-center mt-15">
                <div className="bg-white shadow-1 rounded-md p-2 relative">
