      ...
      <div className="min-w-[275px]">
        <div className="w-max flex items-center rounded-md border border-gray-3">
          <Button
            ...
            className="flex items-center justify-center w-11.5 h-11.5 rounded-none rounded-l-md border-0 ease-out duration-200 hover:text-blue"
          ...
          <Button
            ...
            className="flex items-center justify-center w-11.5 h-11.5 rounded-none rounded-r-md border-0 ease-out duration-200 hover:text-blue"
            disabled={cartLoading || maxAvailableQuantity(item.product) <= 0}
          >
            <svg
              className="fill-current"
              width="20"
