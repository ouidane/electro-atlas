  ...
  const onSubmit = async (data: VerifyEmailSchema) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/auth/verify-email/confirm`,
        {
          method: "POST",
    ...
    <>
      ...
      <section className="overflow-hidden py-20 bg-gray-2 min-h-[60vh] flex items-center justify-center">
        <div className="max-w-[400px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
          <h2 className="font-semibold text-xl sm:text-2xl text-dark mb-4 text-center">
            Verify Your Email
          </h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="mb-5">
              <label htmlFor="verificationCode" className="block mb-2.5">
